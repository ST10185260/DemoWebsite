      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <section class="container single-product my-5 pt-5">
            <div class="row mt-5">
                ...
                <input type="hidden" name="product_image" value="<?php echo $row['product_name']; ?>" />
                <input type="hidden" name="product_image" value="<?php echo $row['product_price']; ?>" />
                


                <div class="col-lg col-md-6 col-sm-12">
                    <img class="img-fluid w-100 pb-1" src="<?php echo $row['product_image']; ?>" alt=""/>
